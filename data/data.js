...
window.TTD_DATA = {
  ...
  "BUILDINGS": [
    ...
    },
    {
      ...
      "cost_raw": "나뭇가지 x4, 돌맹이 x4, 생고기 x4, 산딸기 x1, 맑은물 x1, 버섯 x1"
    },
    {
      "id": "kitchen",
      "name": "화덕",
      ...
      "설명": null,
      "reward_passive": "hunger_max+1",
      "cost_raw": "나뭇가지 x5, 돌맹이 x5, 생고기 x5, 산딸기 x2, 맑은물 x2, 버섯 x2"
    },
    {
      "id": "kitchen",
      "name": "화덕",
  ...
  "ITEMS": [
    ...
    },
    {
      ...
      "머지 가능": false,
      "일회용": true,
      "설명 텍스트": "날것의 덩이뿌리를 화덕에 구우면 더 든든한 식량이 된다.",
      "효과 요약": "화덕에서 구운 든든한 식량.",
      "사용 효과": "hunger+3",
      "merge_result": null,
      "merge_enabled": false,
      "effect": {
  ...
  "CROPS": [
    {
      ...
      "extractCount": 2,
      "extractDays": 1,
      "note": "산딸기 추출 → 씨앗 2개 / 성장 2일·물 1·수확 2"
    },
    {
      "id": "mushroom_spore",
      "seedId": "mushroom_spore",
      "cropName": "버섯",
      "sourceItemId": "mushroom",
      "resultItemId": "mushroom",
      "growDays": 2,
      "waterCost": 0,
      "yieldCount": 2,
      "growType": "shade",
      ...
      "extractCount": 2,
      "extractDays": 1,
      "note": "버섯 추출 → 균사 2개 / 성장 2일·물 0·수확 2 (그늘 재배)"
    },
    {
      "id": "root_tuber_eye",
      "seedId": "root_tuber_eye",
      "cropName": "덩이뿌리",
      "sourceItemId": "root_tuber",
      "resultItemId": "root_tuber",
      "growDays": 3,
      "waterCost": 2,
      "yieldCount": 2,
      "growType": "field",
      ...
      "extractCount": 2,
      "extractDays": 1,
      "note": "덩이뿌리 추출 → 눈 2개 / 성장 3일·물 2·수확 2"
    },
    {
      "id": "herb_seed",
      "seedId": "herb_seed",
      ...
      "extractCount": 2,
      "extractDays": 1,
      "note": "약초 추출 → 씨앗 2개 / 성장 2일·물 1·수확 2"
    },
    {
      "id": "fiber_seed",
      "seedId": "fiber_seed",
      "cropName": "섬유풀",
      "sourceItemId": "fiber_plant",
      "resultItemId": "stem",
      "growDays": 3,
      "waterCost": 1,
      "yieldCount": 2,
      ...
      "extractCount": 2,
      "extractDays": 1,
      "note": "섬유풀 추출 → 씨앗 2개 / 성장 3일·물 1·수확 2 (수확물=줄기)"
    }
  ]
};
